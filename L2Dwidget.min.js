...
var L2Dwidget = function (t) {
    ...
    t.exports = function (t, n, e, d, h, y, b) {
        ...
        if (L && (x = s(L.call(new t))) !== Object.prototype && x.next && (f(x, _, !0), r || "function" == typeof x[l] || c(x, l, v)), j && k && "values" !== k.name && (O = !0, S = function () {
                return k.call(this)
            }), r && !b || !p && !O && P[l] || c(P, l, S), u[n] = S, u[_] = v, h)
            if (m = {
                    values: j ? S : g("values"),
                    keys: y ? S : g("keys"),
                    entries: T
    ...
    for (var r = e(70), o = e(33), i = e(5), c = e(1), u = e(4), a = e(8), f = e(0), s = f("iterator"), l = f("toStringTag"), p = a.Array, v = {
        ...
        var y, b = d[h],
            ...
            w = c[b],
            x = w && w.prototype;
        if (x && (x[s] || u(x, s, p), x[l] || u(x, l, b), a[b] = p, m))
    ...
    M || (S = function (t) {
        ...
        Promise: S
    }), e(25)(S, "Promise"), e(83)("Promise"), c = e(2).Promise, l(l.S + l.F * !M, "Promise", {
        reject: function (t) {
            var n = E(this);
    ...
    (n = t.exports = function (t, n, e, l, p) {
        ...
        if (i(b)) {
            ...
            for (h = b.call(t); !(d = h.next()).done;)
                if ((y = o(h, m, d.value, n)) === f || y === s) return y
    }).BREAK = f, n.RETURN = s
}, function (t, n, e) {
    var r = e(3);
